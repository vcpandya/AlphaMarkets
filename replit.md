...
- SQLite database via `better-sqlite3` at `server/data/alphamarkets.db`
...
On first start, SQLite seeds a default admin user:
- Username: `admin`
...
- `server/src/services/sqliteStorage.ts` — SQLite database layer
